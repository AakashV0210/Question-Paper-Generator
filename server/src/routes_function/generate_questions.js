  ...
  try {
    ...
    for (let j = 0; j < total_mark_10_no; j++) {
      ...
      if (rand_mark_choice === 6) {
        ...
        // console.log("6 4", generated_mark_6_and_4_arr);
      }
